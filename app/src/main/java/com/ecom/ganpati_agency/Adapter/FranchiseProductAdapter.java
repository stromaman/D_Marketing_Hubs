...
public class FranchiseProductAdapter extends RecyclerView.Adapter<FranchiseProductAdapter.ViewHolder> {

    Context context;
    DashboardActivity dashboardActivity;
    List<FranchiseProduct> franchiseProductList;

    public FranchiseProductAdapter(Context context, DashboardActivity dashboardActivity, List<FranchiseProduct> franchiseProductList) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.addLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                dashboardActivity.addToCart(preferences.getUserToken()
