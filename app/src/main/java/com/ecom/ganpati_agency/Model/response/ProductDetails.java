...
public class ProductDetails {
    ...
    @SerializedName("bstselling_status")
    @Expose
    private String bstsellingStatus;
    @SerializedName("bs_adddate")
    @Expose
    private String bsAdddate;
    ...
    @SerializedName("deliveryfreeon")
    @Expose
    private String deliveryfreeon;
    @SerializedName("deliverywithin")
    @Expose
    private String deliverywithin;
    @SerializedName("path")
    @Expose
    private String path;
    ...
    public String getBstsellingStatus() {
        return bstsellingStatus;
    }

    public void setBstsellingStatus(String bstsellingStatus) {
        this.bstsellingStatus = bstsellingStatus;
    }

    public String getBsAdddate() {
        return bsAdddate;
    }

    public void setBsAdddate(String bsAdddate) {
        this.bsAdddate = bsAdddate;
    }
    ...
    public String getDeliveryfreeon() {
        return deliveryfreeon;
    }

    public void setDeliveryfreeon(String deliveryfreeon) {
        this.deliveryfreeon = deliveryfreeon;
    }
